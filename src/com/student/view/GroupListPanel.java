...
public class GroupListPanel extends JPanel {
    ...
    public GroupListPanel() {
        ...
        if (groups == null || groups.length == 0) {
            ...
            data = new String[groups.length][2];
            for (int i = 0; i < groups.length; i++) {
                data[i][0] = String.valueOf(i + 1);
                data[i][1] = groups[i].getName();
            }
        }
        ...
        btnEdit.addActionListener(e -> {
            ...
            // 获取旧的小组目录和新的小组名称
            File oldDir = new File(Constant.FILE_PATH + File.separator + 
                                 Constant.CLASS_PATH + File.separator + 
                                 data[selectedRow][1]);
            File newDir = new File(Constant.FILE_PATH + File.separator + 
                                 Constant.CLASS_PATH + File.separator + 
                                 txtName.getText());
        ...
        btnDelete.addActionListener(e -> {
            ...
            if(JOptionPane.showConfirmDialog(this, "删除小组会把学生和成绩都删除，您确定要删除这个小组？", "", JOptionPane.YES_NO_OPTION) != 0){
                return;
            }
            ...
            if (deleteDirectory(groupDir)) {
                ...
                JOptionPane.showMessageDialog(this, "删除小组失败", "", JOptionPane.ERROR_MESSAGE);
            }
        });
    }
